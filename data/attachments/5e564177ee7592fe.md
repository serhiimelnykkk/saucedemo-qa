...
- Name: inventory.spec.ts >> Inventory with problem_user >> Clicking on product "Sauce Labs Bolt T-Shirt" redirects a user to the item page
- Location: tests/inventory.spec.ts:32:7
...
Expected: "https://www.saucedemo.com/inventory-item.html?id=1"
Received: "https://www.saucedemo.com/inventory-item.html?id=2"
Timeout:  5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    14 × unexpected value "https://www.saucedemo.com/inventory-item.html?id=2"
...
- text: Sauce Labs Onesie Rib snap infant onesie for the junior automation engineer in development. Reinforced 3-snap bottom closure, two-needle hemmed sleeved and bottom won't unravel. $7.99
- button "Add to cart"
- contentinfo:
  - list:
    - listitem:
